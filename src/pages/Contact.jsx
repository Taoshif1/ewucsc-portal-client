...
const Contact = () => {
  ...
  const recruitmentSteps = [
    ...
    { icon: <HiOutlineShieldCheck />, text: "Technical Evaluation & Interview" },
    { icon: <HiOutlineUserGroup />, text: "Trial Period with Active Participation" },
    { icon: <HiOutlineLightBulb />, text: "Full Membership & Growth Tracks" },
  ];

  const benefits = [
    { title: "Skill Development", desc: "Enhance cybersecurity skills through regular practice.", icon: <HiOutlineChartBar />, color: "text-blue-500" },
    { title: "Elite Networking", desc: "Connect with industry professionals and enthusiasts.", icon: <HiOutlineChip />, color: "text-emerald-500" },
    { title: "Global Impact", desc: "Represent EWU in international CTF competitions.", icon: <HiOutlineLightningBolt />, color: "text-purple-500" },
    { title: "Open Research", desc: "Contribute to security projects and vulnerability research.", icon: <HiOutlineGlobe />, color: "text-cyan-500" },
    { title: "Growth Tracks", desc: "Structured paths for beginners to advanced hackers.", icon: <HiOutlineAcademicCap />, color: "text-amber-500" },
    { title: "Live Fire Labs", desc: "Get hands-on experience in our dedicated practice labs.", icon: <HiOutlineFire />, color: "text-red-500" },
  ];
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((item, index) => (
            ...
            >
              <div className={`absolute -right-4 -bottom-4 text-9xl opacity-5 group-hover:opacity-10 transition-opacity ${item.color}`}>
                {item.icon}
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 grid gap-8 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          >
            ...
            <h2 className="text-3xl font-black mb-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
              Join the Elite Ranks
            </h2>
            <p className="text-base-content/70 mb-10 leading-relaxed text-lg">
              We're looking for passionate CTF players and security researchers to join the top cybersecurity ecosystem at East West University.
            </p>
            ...
            <button className="btn btn-primary btn-lg rounded-2xl px-10 group">
              Apply for Membership <HiOutlineArrowRight className="ml-2 group-hover:translate-x-2 transition-transform" />
            </button>
          </motion.div>
        ...
        >
          ...
          <p className="text-sm text-base-content/50 mb-8 font-mono">Direct line for inquiries.</p>
          ...
          <div className="mt-10 flex justify-center gap-8 text-2xl opacity-40">
            <a href="#" className="hover:text-primary transition-all"><FaDiscord /></a>
            <a href="#" className="hover:text-primary transition-all"><FaFacebook /></a>
            <a href="#" className="hover:text-primary transition-all"><FaGithub /></a>
            <a href="#" className="hover:text-primary transition-all"><FaLinkedin /></a>
          </div>
        </motion.div>
      </div>
    </div>
